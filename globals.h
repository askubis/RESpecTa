...
enum Robot {ROBOT_UNDEFINED, ROBOT_IRP6OT_M, ROBOT_IRP6P_M, ROBOT_FESTIVAL, ROBOT_CONVEYOR, ROBOT_SPEAKER,
      ...
      ROBOTS_NUMBER};
static std::string ROBOT_TABLE[10] = {"ROBOT_UNDEFINED","ROBOT_IRP6OT_M","ROBOT_IRP6P_M","ROBOT_FESTIVAL","ROBOT_CONVEYOR",
                            "ROBOT_SPEAKER","ROBOT_IRP6_MECHATRONIKA","ROBOT_ELECTRON","ROBOT_HAND","ROBOT_SPEECHRECOGNITION"};
